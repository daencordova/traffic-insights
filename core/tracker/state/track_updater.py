...
class TrackUpdater(LoggerMixin):
    ...
    def __init__(
        ...
        self.logger.info(
            "TrackUpdater inicializado", use_kalman=use_kalman, optimized=use_optimized_kalman
        )
    ...
    def predict_position(self, track: TrackState) -> None:
        ...
        try:
            ...
            self.logger.debug("Error en predicción Kalman", track_id=track.track_id, error=str(e))
            track.predicted_centroid = track.centroid
    ...
    def correct_position(self, track: TrackState, detection: dict[str, Any]) -> None:
        ...
        try:
            ...
            self._stats["kalman_errors"] += 1
            self.logger.debug("Error en corrección Kalman", track_id=track.track_id, error=str(e))
    ...
    def init_kalman(self, track: TrackState) -> None:
        ...
        try:
            ...
            self._stats["kalman_errors"] += 1
            self.logger.warning("Error inicializando Kalman", track_id=track.track_id, error=str(e))
    ...
    def validate_motion_consistency(self, track: TrackState, detection: dict[str, Any]) -> bool:
        ...
        expected_speed = np.sqrt(track.velocity[0] ** 2 + track.velocity[1] ** 2)
