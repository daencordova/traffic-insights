...
Este módulo contiene todas las enumeraciones utilizadas en el sistema,
organizadas por dominio de aplicación.
"""
...
class CongestionLevel(Enum):
    ...
    def from_occupancy(cls, occupancy: float) -> "CongestionLevel":
        ...
        Args:
            occupancy: Porcentaje de ocupación (0-1).

        Returns:
            CongestionLevel: Nivel de congestión correspondiente.
        """
